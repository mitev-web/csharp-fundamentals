...
class HappyTickets
    {
        static void Main(string[] args)
        {
            ...
            decimal first3Numbers = decimal.Parse(number[0].ToString()) + decimal.Parse(number[1].ToString()) + decimal.Parse(number[2].ToString());
            decimal second3Numbers = decimal.Parse(number[3].ToString()) + decimal.Parse(number[4].ToString()) + decimal.Parse(number[5].ToString());
            ...
            if (decimal.Parse(number[1].ToString()) > decimal.Parse(number[3].ToString()))
            {
