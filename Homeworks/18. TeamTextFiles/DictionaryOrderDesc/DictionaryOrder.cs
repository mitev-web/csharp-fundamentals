...
class DictionaryOrder
{
    ...
    static void Main(string[] args)
    {
        try
        {
            string text = "../../Files/text.txt";
            string[] words = FileToString(text).Split(' ').ToArray();
            string wordsTofind = "../../Files/words.txt";
            string[] test = FileToString(wordsTofind).Split(new string[] { "\n" }, StringSplitOptions.None);
